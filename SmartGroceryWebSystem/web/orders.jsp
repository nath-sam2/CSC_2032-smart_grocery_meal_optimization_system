...
.help-card{ margin-top:auto; background:linear-gradient(135deg,#16a34a,#22c55e); border-radius:16px; padding:18px; cursor:pointer; border:none; text-align:left; width:100%; text-decoration:none; display:block; color:white; position:sticky;bottom:0;z-index:5;box-shadow:0 -12px 12px -6px #111; }
