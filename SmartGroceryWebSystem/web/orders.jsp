...
.help-card{ margin-top:24px; background:linear-gradient(135deg,#16a34a,#22c55e); border-radius:16px; padding:18px; cursor:pointer; border:none; text-align:left; width:100%; text-decoration:none; display:block; color:white; position:static; }
